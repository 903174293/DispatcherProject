...
//		String val = ServletObjectUtil.getRequest().getParameter(paramName) ;	// 获得请求参数信息
		String val = ServletObjectUtil.getParam().getParameter(paramName) ;	// 获得请求参数信息------------------------表单封装接收参数
		...
		if ("string[]".equalsIgnoreCase(rule)) {	// 进行字符串验证
//			String vals [] = ServletObjectUtil.getRequest().getParameterValues(paramName) ;
			String vals [] = ServletObjectUtil.getParam().getParameterValues(paramName) ;//------------------------表单封装接收参数
