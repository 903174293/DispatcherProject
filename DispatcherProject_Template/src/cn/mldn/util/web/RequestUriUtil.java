...
public class RequestUriUtil {
	 ...
	 * @param request 请求对象
	 * @return 返回的信息里面包含有两个元素：<br>
	 * <li>第一个元素（索引0）为Action的访问路径。</li>
	 * <li>第二个元素（索引1）为Action类中的调用方法名称。</li>
	 */
...
//		String temp [] = uri.split("!") ;	// 按照“!”拆分
		String temp [] = uri.split("!|%21") ;	// 按照“!”拆分-------------------关键注意：“!|%21的意义” forward跳转之后！会变成“%21”
